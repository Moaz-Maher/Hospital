...
public class Patient {
    private Font buttonFont = new Font("Arial", Font.BOLD, 24), labelFont = new Font("Arial", Font.BOLD, 22),
            font = new Font("Arial", Font.BOLD, 18);
    private Color blue = new Color(1, 50, 67), gray = new Color(150, 150, 150), white = new Color(242, 242, 242);
    private JButton back;

    public Patient(JPanel sidebar, JButton doctor, JButton nurse, JButton patient, JButton exit, JPanel content,
